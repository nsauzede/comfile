/* comfile.c: Loadable kernel module implementing command executables. (0.3)
 * Copyright 2019 Brian Raiter <breadbox@muppetlabs.com>.
 * Slight changes to reduce bin sizes and build on recent Linux systems. (0.4)
 * Copyright 2025 Nicolas Sauzede <nicolas.sauzede@gmail.com>.
